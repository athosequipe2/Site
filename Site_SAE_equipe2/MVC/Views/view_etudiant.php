                    ...
                    <div class="grandblock">
                        <div class="row">
                            <div class="col-md-8 col-sm-12">
                                ...
                                <input type="text" id="myInput" onkeyup="myFunction()" placeholder="Numéro étudiants" title="Type in a name">
                            </div>
                        ...
                        <div class="table-responsive">
                            <table class="table table-hover table-striped tm-table-striped-even mt-3">
                                ...
                                <tbody id ="myTable">
                                    <?php             
                                    $liste = ["dfwgwdg","dfwhg","fdfggdh","ffgghkj","dfwgwdg","dfwhfgg","ffgdgdh","fghkdgfwj","dfwgwdg","dfwhwgfdg","fgdhwdgf","fwgfghkj"];                    
